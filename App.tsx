    ...
    <div className='min-h-screen selection:bg-rose-200 relative overflow-x-hidden'>
      ...
      <nav className='fixed top-0 left-0 right-0 z-50 bg-white/70 backdrop-blur-md border-b border-rose-100'>
        <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
          <span className='font-romantic text-2xl text-rose-600 font-bold'>
            lil tweaker
          </span>
      ...
      >
        ...
        <div className='text-center max-w-4xl mx-auto'>
          ...
          <p className='text-xl md:text-2xl font-serif-elegant text-rose-700 mb-12 italic leading-relaxed'>
            I really enjoyed being with you over the past seconds, hours, days,
            MONTHS. You are funny, pretty, and you have grown into a very
            thoughtful girl. I am thankful that l got to know all of you
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {INITIAL_MEMORIES.map((memory) => (
              <div
                key={memory.id}
                className='group relative overflow-hidden rounded-3xl shadow-lg transform hover:scale-[1.03] transition-all duration-500'
              >
                <img
                  src={memory.url}
                  alt={memory.caption}
                ...
                <div className='absolute inset-0 bg-gradient-to-t from-rose-900/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6'>
                  <p className='text-white text-xl font-romantic'>
                    {memory.caption}
                  </p>
                </div>
              </div>
      ...
      <footer className='bg-rose-900 text-rose-100 py-20 px-6 text-center'>
        <div className='max-w-xl mx-auto'>
          <div className='font-romantic text-4xl mb-6'>lil monkey</div>
          <p className='font-serif-elegant italic text-rose-200 mb-8 leading-relaxed'></p>
          ...
          <p className='text-rose-400 text-xs tracking-widest uppercase'>
            Made with love by {config.userName} • Anniversary{' '}
